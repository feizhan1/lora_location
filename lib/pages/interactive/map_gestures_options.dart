...
import 'package:lora_location/base_page.dart';
import 'package:lora_location/const_config.dart';
import 'package:lora_location/widgets/amap_gridview.dart';
import 'package:lora_location/widgets/amap_switch_button.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: AMapGradView(childrenWidgets: gesturesOptions, childAspectRatio: 2, crossAxisCount: 4, ),
            ),
          ],
        ),
      );
